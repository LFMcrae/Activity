...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button goSecond = (Button)findViewById(R.id.go);
        final EditText textToSecond = (EditText)findViewById(R.id.user1);
        ...
        switch (requestCode){
            case 1:
                if(resultCode == RESULT_OK){
                    ...
                    TextView textFromSecond = (TextView)findViewById(R.id.textview1);
